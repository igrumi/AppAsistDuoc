...
export class LoginPage implements OnInit {
  ...
  */
    ...
    /*
      Las siguientes 3 líneas de código sirven para lo siguiente:
        ...
        Caso 2: Si dejas las instrucciones sin comentar, entonces entrará inmediatamente a la página home,
          ...
          recuerda colocar // para comentar esto
    */
  ...
  public ingresar(): void {
    if(!(this.usuario.validarCuentaUsuario(this.usuario.nombreUsuario,this.usuario.password))){
      return
    }
    ...
    */
    ...
    this.router.navigate(['/tabs/home'], navigationExtras); // Navegamos hacia el Home y enviamos la información extra
  }
